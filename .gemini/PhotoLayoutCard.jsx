import frameMappings from "../src/components/frameMappings";
import FrameLayout from "../src/components/FrameLayout";
...
export default function PhotoLayoutCard({ images, filters, selectedDesign }) {
  ...
  if (mapping) {
    return (
      <div
        className={`${colors.card} rounded-2xl shadow-2xl p-6 flex flex-col items-center`}
      >
